...
public class Boss1 extends Creature
{
    ...
    public void tick()
    {
        ...
        if(handler.getWorld().getEntityManager().getPlayer().getKilledBosses() > 0)
            suicide();
    ...
    public void die()
    {
        ...
        handler.getWorld().getItemManager().addItem(Item.ironBarItem.createNew((int)x, (int) y, false, false, false));
        handler.getWorld().getEntityManager().getPlayer().setKilledBosses(1);
    }
