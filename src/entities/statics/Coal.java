...
public class Coal extends StaticEntity
{
    ...
    public Coal(Handler handler, float x, float y, int id, boolean isActive)
    {
        super(handler, x, y, 64, 64, maxHealth, id, "Coal");
        this.id = id;
        this.health = maxHealth;
    ...
    public void die()
    {
        handler.getWorld().getItemManager().addItem(Item.coalItem.createNew((int)x, (int)y, false, false, false));
    }

    public void render(Graphics g)
    {
        g.drawImage(Assets.coal, (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
