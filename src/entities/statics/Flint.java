...
public class Flint extends StaticEntity
{
    ...
    public void die()
    {
        handler.getWorld().getItemManager().addItem(Item.flintItem.createNew((int)x, (int)y, false, false, false));
    }

    public void render(Graphics g)
    {
        g.drawImage(Assets.flintRock, (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
