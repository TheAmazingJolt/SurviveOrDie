...
public class HellTree extends StaticEntity
{
    ...
    public void die()
    {
        handler.getWorld().getItemManager().addItem(Item.ashyWoodItem.createNew((int)x + 16, (int)y + 64, false, false, false));
    }

    public void render(Graphics g)
    {
        g.drawImage(Assets.hellTree, (int)(x - handler.getGameCamera().getxOffset()), (int)(y - handler.getGameCamera().getyOffset()), width, height, null);
